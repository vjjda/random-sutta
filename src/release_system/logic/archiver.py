# Path: src/release_system/logic/archiver.py
import logging
import os
import zipfile
from pathlib import Path

from ..config import WEB_DIR, RELEASE_DIR, APP_NAME

logger = logging.getLogger("Release.Archiver")
