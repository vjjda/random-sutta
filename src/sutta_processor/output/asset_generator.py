...
# ... (Giữ nguyên hàm write_book_file) ...
def write_book_file(
    group_name: str, 
...
# ... (Giữ nguyên hàm update_service_worker) ...
...
def write_loader_script(file_list: List[str]) -> None:
    """
    [UPDATED] Tạo file module index thay vì global script.
    ...
    try:
        ...
        with open(loader_path, "w", encoding="utf-8") as f:
            f.write(js_content)
        logger.info(f"✅ File Index generated at: {loader_path}")
        
        update_service_worker(valid_files)
        
    except Exception as e:
        logger.error(f"❌ Failed to write file_index: {e}")