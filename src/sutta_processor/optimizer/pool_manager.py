...
class PoolManager:
    ...
    def generate_js_constants(self) -> None:
        ...
        # [UPDATED] Thêm sort_keys=True vào RANDOM_POOLS để ổn định thứ tự build
        content = (
            ...
            f"export const RANDOM_POOLS = {json.dumps(self.random_pools, separators=(',', ':'), sort_keys=True)};\n"
        )
